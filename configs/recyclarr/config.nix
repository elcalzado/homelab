{ radarrApiKeyPath, sonarrApiKeyPath }:
{
  radarr.movies = {
    ...
    quality_profiles = [
      {
        ...
        min_format_score = 0; # deviates from TRaSH's default of 1000
    ...
    custom_formats = [
      ...
      {
        # Present-but-neutral streaming services (score 0)
        trash_ids = [
